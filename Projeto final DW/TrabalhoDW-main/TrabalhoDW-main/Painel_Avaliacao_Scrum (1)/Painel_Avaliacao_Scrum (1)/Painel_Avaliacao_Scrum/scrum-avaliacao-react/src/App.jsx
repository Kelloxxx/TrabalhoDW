...
import { buildInitialData, setByPath } from './utils/dataHelpers';
...
import CorrupSabotagem from './components/CorrupSabotagem';  // ← ADICIONADO
import Resultado from './components/Resultado';              // ← ADICIONADO
